...
local Window = Fluent:CreateWindow({
    Title = "Yakuza Hub" .. " | ".."BlueLock : Rivals".." | ".."[Version Beta]",
    SubTitle = "By Firezer",
    TabWidth = 160,
...
do
    ...
    Function_Storage.CreateFeariseHubMobileToggle = function()
		...
		feariseHubMobile.Name = "Yakuza Hub Moblie"
...
SaveManager:SetFolder("Yakuza Hub")
InterfaceManager:SetFolder("Yakuza Hub")
